...
<template>
  <div class="text-center">
    ...
    <div>
      ...
      <div class="flex items-center justify-between max-w-md mx-auto mt-10">
        <svg
          class="logo"
          viewBox="0 0 128 128"
          width="50"
    ...
    <div class="mockup-code max-w-2xl mx-auto text-left mt-10">
      <pre data-prefix="$"><code>pnpm dev</code></pre>
    </div>
  </div>

  <!-- section2 -->
  <div class="bg-base-200 mt-10 text-center py-20">
    <h1 class="text-2xl font-bold dark:text-slate-200">Render Pipeline</h1>
    <p
      class="py-6 text-lg max-w-[700px] mx-auto text-slate-500 dark:text-slate-400"
    >
      Vue templates are compiled into render functions: functions that return
      virtual DOM trees. This step can be done either ahead-of-time via a build
      step, or on-the-fly by using the runtime compiler.
    </p>

    <div class="max-w-2xl mx-auto">
      <img src="https://vuejs.org/assets/render-pipeline.03805016.png" alt="" />
    </div>
  </div>
</template>
